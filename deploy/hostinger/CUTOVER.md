...
4. Point Cloudflare / tunnel for `anps.thebrainerp.com` → `http://127.0.0.1:12784`. ← **Step 4 BLOCKED** pending CF API token (see `STEP4_CUTOVER.md`); scripts ready: `bin/cutover_cloudflare_anps.sh`.
